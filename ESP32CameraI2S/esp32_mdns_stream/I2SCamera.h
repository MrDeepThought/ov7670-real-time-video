...
#include "esp_attr.h"                // IRAM_ATTR (no longer pulled in transitively)
#include "freertos/FreeRTOS.h"       // vTaskDelay / xTaskGetTickCount in stop()
#include "freertos/task.h"
#include "esp_rom_gpio.h"            // esp_rom_gpio_connect_in_signal (replaces gpio_matrix_in)
#include "soc/soc.h"
#include "soc/gpio_struct.h"        // GPIO register struct instance
#include "soc/gpio_sig_map.h"
#include "soc/i2s_reg.h"
#include "soc/i2s_struct.h"
#include "soc/io_mux_reg.h"
#include "driver/gpio.h"
#include "esp_private/periph_ctrl.h" // periph_module_enable (was driver/periph_ctrl.h)
#include "soc/lldesc.h"              // lldesc_t (was rom/lldesc.h)
#include "XClk.h"
#include "DMABuffer.h"
...
class I2SCamera
{
  ...
  void stop()
  {
    ...
    while(stopSignal)
    {
      // Frame period is tens of ms; yield so the Arduino loopTask (same core,
      // lower priority) is not starved. Bail out if a frame never completes.
